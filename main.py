...
def build_financial_crew(asset_selection="AAPL", risk_tolerance="Medium", news_impact_consideration=True):
    logging.info(f"Building financial crew for asset selection: {asset_selection} with risk tolerance {risk_tolerance}.")
    ...
    # Create manager LLM
    #manager_llm = CustomLLM(api_key=api_key)  # for GROQ
